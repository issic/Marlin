...
#define STRING_CONFIG_H_AUTHOR "(issic, Ender 3 Pro Turbo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender3 ProT"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -10, -3.100 }
